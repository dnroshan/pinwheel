...
void pw_canvas_object_set_visible     (PwCanvasObject *self,
                                       gboolean        value);
void pw_canvas_object_set_active      (PwCanvasObject *self,
                                       gboolean        value);
void pw_canvas_object_set_interactive (PwCanvasObject *self,
                                       gboolean        value);

void pw_canvas_object_set_bounds (PwCanvasObject     *self,
                                  const GdkRectangle *bounds);
void pw_canvas_object_set_x      (PwCanvasObject *self,
                                  gdouble         value);
void pw_canvas_object_set_y      (PwCanvasObject *self,
                                  gdouble         value);
void pw_canvas_object_set_width  (PwCanvasObject *self,
                                  gdouble         value);
void pw_canvas_object_set_height (PwCanvasObject *self,
                                  gdouble         value);

gdouble         pw_canvas_object_hit  (PwCanvasObject *self,
                                       gdouble         x,
                                       gdouble         y);
PwCanvasObject *pw_canvas_object_pick (PwCanvasObject *self,
                                       gdouble         x,
                                       gdouble         y);
